...
<head>
    ...
    <title><?php wp_reset_query(); if( is_front_page()) { echo bloginfo("name"); echo " - "; echo bloginfo("description"); } else { 
                 ...
                 $preload = ot_get_option( 'preloader_set' ); if ($preload == 'show_home') {  ?>
                    ...
                    <div id="preloader">
                        ...
                        <?php if ( function_exists( 'ot_get_option' ) ) :if (ot_get_option( 'loader_logo')) :  ?>
                             <img src="<?php echo ot_get_option( 'loader_logo'); ?>" alt="Loading Content..">
                        <?php  else :  ?>
                            <p><?php _e('Loading Content...','beuh'); ?></p>
                        <?php endif ; endif; ?>
                        </div>
                    </div>
