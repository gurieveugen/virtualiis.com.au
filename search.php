        ...
        <div class="container clearfix">
             <div class="row clearfix">
                <div class="col-md-8 blog-content">
                	<h3 class="small-title"><?php _e('Search result for ', 'beuh'); the_search_query(); ?>:</h3>
                    <div class="content-divider small clearfix"></div>
                	<!--BLOG POST START-->
                    ...
                    <?php endwhile; else: ?>
                    <p><?php _e('Sorry, no results found. ','beuh'); ?></p>
                    <?php endif; ?>
                    <!--BLOG POST END-->
                    
                    <ul class="pagination clearfix">
                        <li><?php  previous_posts_link('&laquo; Previous Page')  ?></li>
                        <li><?php next_posts_link('Next Post &raquo;'); ?> </li>
                    </ul>
                    <div class="spacing40 clearfix"></div>
                </div><!--/.col-md-8-->
